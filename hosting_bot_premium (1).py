...
def create_admin_panel():
    """𝐂𝐫𝐞𝐚𝐭𝐞 𝐚𝐝𝐦𝐢𝐧 𝐩𝐚𝐧𝐞𝐥 (𝐑𝐞𝐩𝐥𝐲 𝐊𝐞𝐲𝐛𝐨𝐚𝐫𝐝)"""
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True, one_time_keyboard=True)
    markup.add(
        types.KeyboardButton(B('➕ 𝐀𝐝𝐝 𝐀𝐝𝐦𝐢𝐧')),
        types.KeyboardButton(B('➖ 𝐑𝐞𝐦𝐨𝐯𝐞 𝐀𝐝𝐦𝐢𝐧'))
    )
    markup.add(
        types.KeyboardButton(B('📋 𝐋𝐢𝐬𝐭 𝐀𝐝𝐦𝐢𝐧𝐬')),
        types.KeyboardButton(B('📊 𝐒𝐲𝐬𝐭𝐞𝐦 𝐒𝐭𝐚𝐭𝐬'))
    )
    markup.add(types.KeyboardButton(B('🔙 𝐁𝐚𝐜𝐤')))
    return markup

def create_subscription_menu():
    """𝐂𝐫𝐞𝐚𝐭𝐞 𝐬𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧 𝐦𝐞𝐧𝐮 (𝐑𝐞𝐩𝐥𝐲 𝐊𝐞𝐲𝐛𝐨𝐚𝐫𝐝)"""
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True, one_time_keyboard=True)
    markup.add(
        types.KeyboardButton(B('➕ 𝐀𝐝𝐝 𝐒𝐮𝐛')),
        types.KeyboardButton(B('➖ 𝐑𝐞𝐦𝐨𝐯𝐞 𝐒𝐮𝐛'))
    )
    markup.add(types.KeyboardButton(B('🔍 𝐂𝐡𝐞𝐜𝐤 𝐒𝐮𝐛')))
    markup.add(types.KeyboardButton(B('🔙 𝐁𝐚𝐜𝐤')))
    return markup
...
def save_subscription(user_id, days=30, tier='premium'):
    """𝐒𝐚𝐯𝐞 𝐮𝐬𝐞𝐫 𝐬𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧"""
    conn = sqlite3.connect(DATABASE_PATH)
    c = conn.cursor()
    expiry = (datetime.now() + timedelta(days=days)).isoformat()
    c.execute('''INSERT OR REPLACE INTO subscriptions (user_id, expiry, tier, created_at)
                 VALUES (?, ?, ?, ?)''', (user_id, expiry, tier, datetime.now().isoformat()))
    conn.commit()
    conn.close()
    user_subscriptions[user_id] = {'expiry': datetime.now() + timedelta(days=days), 'tier': tier}

def remove_subscription_db(user_id):
    """𝐑𝐞𝐦𝐨𝐯𝐞 𝐮𝐬𝐞𝐫 𝐬𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧"""
    conn = sqlite3.connect(DATABASE_PATH)
    c = conn.cursor()
...
def generate_referral_code(user_id):
    """𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐞 𝐫𝐞𝐟𝐞𝐫𝐫𝐚𝐥 𝐜𝐨𝐝𝐞 𝐟𝐨𝐫 𝐮𝐬𝐞𝐫"""
    return hashlib.sha256(f"{user_id}_referral".encode()).hexdigest()[:8].upper()

def get_referral_count(user_id):
    """𝐆𝐞𝐭 𝐫𝐞𝐟𝐞𝐫𝐫𝐚𝐥 𝐜𝐨𝐮𝐧𝐭 𝐟𝐨𝐫 𝐮𝐬𝐞𝐫"""
    # 𝐈𝐧-𝐦𝐞𝐦𝐨𝐫𝐲 𝐫𝐞𝐟𝐞𝐫𝐫𝐚𝐥 𝐜𝐨𝐮𝐧𝐭
    referral_counts = getattr(get_referral_count, '_counts', {})
    return referral_counts.get(user_id, 0)
...
/speed — 𝐒𝐩𝐞𝐞𝐝 𝐭𝐞𝐬𝐭
/referral — 𝐈𝐧𝐯𝐢𝐭𝐞 𝐟𝐫𝐢𝐞𝐧𝐝𝐬
/refer — 𝐒𝐚𝐦𝐞 𝐚𝐬 /referral
/leaderboard — 𝐓𝐨𝐩 𝐫𝐞𝐟𝐞𝐫𝐫𝐚𝐥𝐬
...
*𝐀𝐮𝐭𝐨-𝐑𝐞𝐜𝐨𝐯𝐞𝐫𝐲:*
✅ 𝐏𝐫𝐞𝐦𝐢𝐮𝐦/𝐎𝐰𝐧𝐞𝐫: 𝐀𝐥𝐰𝐚𝐲𝐬
❌ 𝐅𝐫𝐞𝐞: 𝐑𝐞𝐟𝐞𝐫 𝟑+ 𝐟𝐫𝐢𝐞𝐧𝐝𝐬"""
...
def show_referral(message):
    ...
    referral_link = f"https://t.me/share/url?url=https://t.me/{bot.get_me().username}?start=ref_{referral_code}"
...
🎟️ *𝐘𝐨𝐮𝐫 𝐂𝐨𝐝𝐞:* `{referral_code}`
👥 *𝐑𝐞𝐟𝐞𝐫𝐫𝐚𝐥𝐬:* {referral_count}

*𝐑𝐞𝐰𝐚𝐫𝐝𝐬:*
• 𝐑𝐞𝐟𝐞𝐫 𝟑 𝐟𝐫𝐢𝐞𝐧𝐝𝐬 → 𝐀𝐮𝐭𝐨-𝐫𝐞𝐬𝐭𝐚𝐫𝐭 𝐞𝐧𝐚𝐛𝐥𝐞𝐝
• 𝐄𝐚𝐜𝐡 𝐫𝐞𝐟𝐞𝐫𝐫𝐚𝐥 = 𝐎𝐧𝐞 𝐧𝐞𝐰 𝐮𝐬𝐞𝐫
...
/leaderboard"""
    ...
    bot.reply_to(message, referral_text, parse_mode='Markdown',
                 reply_markup=create_reply_keyboard_main_menu(user_id))
...
def show_leaderboard(message):
    ...
    counts = getattr(get_referral_count, '_counts', {})
    
    if not counts:
        bot.reply_to(message, B("🏆 𝐍𝐨 𝐫𝐞𝐟𝐞𝐫𝐫𝐚𝐥𝐬 𝐲𝐞𝐭!"),
                     reply_markup=create_reply_keyboard_main_menu(user_id))
        return
    ...
    board_text = "╔══════════════════════════════════╗\n"
    board_text += "║    🏆 𝐑𝐄𝐅𝐄𝐑𝐑𝐀𝐋 𝐋𝐄𝐀𝐃𝐄𝐑𝐁𝐎𝐀𝐑𝐃     ║\n"
    board_text += "╚══════════════════════════════════╝\n\n"
...
def callback_router(call):
    ...
    try:
        if data == 'upload':
            ...
            _callback_check_files(call, user_id)
            ...
            if user_id in admin_ids:
                bot.answer_callback_query(call.id, "👑 𝐎𝐩𝐞𝐧𝐢𝐧𝐠 𝐀𝐝𝐦𝐢𝐧 𝐏𝐚𝐧𝐞𝐥")
                bot.edit_message_text(
                    B("👑 𝐀𝐃𝐌𝐈𝐍 𝐏𝐀𝐍𝐄𝐋\n\n➕ 𝐀𝐝𝐝 𝐀𝐝𝐦𝐢𝐧\n➖ 𝐑𝐞𝐦𝐨𝐯𝐞 𝐀𝐝𝐦𝐢𝐧\📋 𝐋𝐢𝐬𝐭 𝐀𝐝𝐦𝐢𝐧𝐬\📊 𝐒𝐲𝐬𝐭𝐞𝐦 𝐒𝐭𝐚𝐭𝐬"),
                    call.message.chat.id, call.message.message_id, parse_mode='Markdown',
                    reply_markup=create_admin_panel()
                )
            else:
                bot.answer_callback_query(call.id, "🔒 𝐍𝐨𝐭 𝐚𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝", show_alert=True)
        
        elif data == 'subscription':
            if user_id in admin_ids:
                bot.answer_callback_query(call.id, "💳 𝐒𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧 𝐏𝐚𝐧𝐞𝐥")
                bot.edit_message_text(
                    B("💳 𝐒𝐔𝐁𝐒𝐂𝐑𝐈𝐏𝐓𝐈𝐎𝐍 𝐏𝐀𝐍𝐄𝐋\n\n➕ 𝐀𝐝𝐝 𝐒𝐮𝐛\n➖ 𝐑𝐞𝐦𝐨𝐯𝐞 𝐒𝐮𝐛\🔍 𝐂𝐡𝐞𝐜𝐤 𝐒𝐮𝐛"),
                    call.message.chat.id, call.message.message_id, parse_mode='Markdown',
            ...
            if user_id in admin_ids:
                bot.answer_callback_query(call.id, "📢 𝐒𝐞𝐧𝐝 𝐦𝐞𝐬𝐬𝐚𝐠𝐞 𝐭𝐨 𝐛𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭")
            else:
                bot.answer_callback_query(call.id, "🔒 𝐍𝐨𝐭 𝐚𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝", show_alert=True)
            ...
            if user_id in admin_ids:
                global bot_locked
                bot_locked = True
                bot.answer_callback_query(call.id, "🔒 𝐁𝐨𝐭 𝐋𝐨𝐜𝐤𝐞𝐝")
                bot.edit_message_text(B("🔒 𝐁𝐨𝐭 𝐢𝐬 𝐧𝐨𝐰 𝐋𝐎𝐂𝐊𝐄𝐃.\n𝐎𝐧𝐥𝐲 𝐚𝐝𝐦𝐢𝐧𝐬 𝐜𝐚𝐧 𝐮𝐬𝐞 𝐢𝐭."),
            ...
            if user_id in admin_ids:
                bot_locked = False
                bot.answer_callback_query(call.id, "🔓 𝐁𝐨𝐭 𝐔𝐧𝐥𝐨𝐜𝐤𝐞𝐝")
                bot.edit_message_text(B("🔓 𝐁𝐨𝐭 𝐢𝐬 𝐧𝐨𝐰 𝐔𝐍𝐋𝐎𝐂𝐊𝐄𝐃."),
                                     call.message.chat.id, call.message.message_id,
                                     reply_markup=create_reply_keyboard_main_menu(user_id))
            else:
                bot.answer_callback_query(call.id, "🔒 𝐍𝐨𝐭 𝐚𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝", show_alert=True)
            ...
            if user_id in admin_ids:
                _callback_analytics(call, user_id)
            else:
                bot.answer_callback_query(call.id, "🔒 𝐍𝐨𝐭 𝐚𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝", show_alert=True)
        ...
        # 𝐇𝐚𝐧𝐝𝐥𝐞 𝐟𝐢𝐥𝐞 𝐜𝐨𝐧𝐭𝐫𝐨𝐥 𝐜𝐚𝐥𝐥𝐛𝐚𝐜𝐤𝐬
        elif data.startswith('start_'):
            file_name = data.replace('start_', '')
            _start_script_from_callback(call, user_id, file_name)
        
        elif data.startswith('stop_'):
            file_name = data.replace('stop_', '')
            _stop_script_from_callback(call, user_id, file_name)
        
        elif data.startswith('restart_'):
            file_name = data.replace('restart_', '')
            _restart_script_from_callback(call, user_id, file_name)
        
        elif data.startswith('delete_'):
            file_name = data.replace('delete_', '')
            _delete_script_from_callback(call, user_id, file_name)
        
        elif data.startswith('logs_'):
            file_name = data.replace('logs_', '')
            _show_logs_from_callback(call, user_id, file_name)
...
@bot.message_handler(func=lambda message: message.text and (
    ...
    message.text == B("📂 𝐌𝐲 𝐅𝐢𝐥𝐞𝐬") or
    message.text == B("⚡ 𝐒𝐩𝐞𝐞𝐝") or
    message.text == B("📊 𝐒𝐭𝐚𝐭𝐬") or
    message.text == B("👤 𝐏𝐫𝐨𝐟𝐢𝐥𝐞") or
    message.text == B("📦 𝐌𝐨𝐝𝐮𝐥𝐞") or
    message.text == B("👑 𝐀𝐝𝐦𝐢𝐧") or
    message.text == B("💳 𝐒𝐮𝐛𝐬") or
    message.text == B("📢 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭") or
    message.text == B("🔄 𝐑𝐞𝐜𝐨𝐯𝐞𝐫") or
    message.text == B("🔄 𝐑𝐞𝐬𝐭𝐚𝐫𝐭 𝐀𝐥𝐥") or
    message.text == B("🚀 𝐑𝐞𝐬𝐭𝐚𝐫𝐭 𝐁𝐨𝐭") or
    message.text == B("🔙 𝐁𝐚𝐜𝐤")
))
def handle_main_menu_text(message):
    """𝐇𝐚𝐧𝐝𝐥𝐞 𝐦𝐚𝐢𝐧 𝐦𝐞𝐧𝐮 𝐭𝐞𝐱𝐭 𝐛𝐮𝐭𝐭𝐨𝐧𝐬"""
    user_id = message.from_user.id
    add_active_user(user_id)
    ...
    if B("📤 𝐔𝐩𝐥𝐨𝐚𝐝") in text:
        bot.reply_to(message, B("📤 𝐒𝐞𝐧𝐝 𝐲𝐨𝐮𝐫 .𝐩𝐲 𝐨𝐫 .𝐣𝐬 𝐟𝐢𝐥𝐞 𝐧𝐨𝐰!"),
                     reply_markup=create_reply_keyboard_main_menu(user_id))
    
    elif B("📂 𝐌𝐲 𝐅𝐢𝐥𝐞𝐬") in text:
        _callback_check_files_direct(message, user_id)
    
    elif B("⚡ 𝐒𝐩𝐞𝐞𝐝") in text:
        run_speedtest(message)
    
    elif B("📊 𝐒𝐭𝐚𝐭𝐬") in text:
        show_stats(message)
    
    elif B("👤 𝐏𝐫𝐨𝐟𝐢𝐥𝐞") in text:
        show_profile(message)
    
    elif B("📦 𝐌𝐨𝐝𝐮𝐥𝐞") in text:
        _callback_module_menu_direct(message, user_id)
    
    elif B("👑 𝐀𝐝𝐦𝐢𝐧") in text:
        if user_id in admin_ids:
            bot.reply_to(message, B("👑 𝐀𝐃𝐌𝐈𝐍 𝐏𝐀𝐍𝐄𝐋"),
                         reply_markup=create_admin_panel())
        else:
            bot.reply_to(message, "🔒 𝐍𝐨𝐭 𝐚𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝.")
    
    elif B("💳 𝐒𝐮𝐛𝐬") in text:
        if user_id in admin_ids:
            bot.reply_to(message, B("💳 𝐒𝐔𝐁𝐒𝐂𝐑𝐈𝐏𝐓𝐈𝐎𝐍 𝐏𝐀𝐍𝐄𝐋"),
                         reply_markup=create_subscription_menu())
        else:
            bot.reply_to(message, "🔒 𝐍𝐨𝐭 𝐚𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝.")
    
    elif B("📢 𝐁𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭") in text:
        if user_id in admin_ids:
            bot.reply_to(message, B("📢 𝐒𝐞𝐧𝐝 𝐦𝐞𝐬𝐬𝐚𝐠𝐞 𝐭𝐨 𝐛𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭:"))
        else:
            bot.reply_to(message, "🔒 𝐍𝐨𝐭 𝐚𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝.")
    
    elif B("🔄 𝐑𝐞𝐜𝐨𝐯𝐞𝐫") in text:
        if user_id in admin_ids:
            ...
            try:
                if recovered:
                    bot.edit_message_text(
                        B(f"✅ 𝐑𝐞𝐜𝐨𝐯𝐞𝐫𝐞𝐝: {len(recovered)} 𝐬𝐜𝐫𝐢𝐩𝐭(𝐬)"),
                        message.chat.id, msg.message_id,
                        reply_markup=create_reply_keyboard_main_menu(user_id)
                    )
                else:
                    bot.edit_message_text(B("📭 𝐍𝐨𝐭𝐡𝐢𝐧𝐠 𝐭𝐨 𝐫𝐞𝐜𝐨𝐯𝐞𝐫."),
                                         message.chat.id, msg.message_id,
                                         reply_markup=create_reply_keyboard_main_menu(user_id))
            except Exception:
                pass
    ...
    elif B("🔄 𝐑𝐞𝐬𝐭𝐚𝐫𝐭 𝐀𝐥𝐥") in text:
        _callback_restart_all_direct(message, user_id)
    
    elif B("🚀 𝐑𝐞𝐬𝐭𝐚𝐫𝐭 𝐁𝐨𝐭") in text:
        if user_id in admin_ids:
            bot.reply_to(message, B("🚀 𝐑𝐞𝐬𝐭𝐚𝐫𝐭𝐢𝐧𝐠 𝐛𝐨𝐭..."))
            threading.Thread(target=send_restart_notification).start()
            time.sleep(1)
            os.execl(sys.executable, sys.executable, *sys.argv)
        else:
...
def _callback_check_files_direct(message, user_id):
    """𝐒𝐡𝐨𝐰 𝐟𝐢𝐥𝐞𝐬 𝐝𝐢𝐫𝐞𝐜𝐭𝐥𝐲 𝐟𝐫𝐨𝐦 𝐭𝐞𝐱𝐭 𝐛𝐮𝐭𝐭𝐨𝐧"""
    files = user_files.get(user_id, [])
    if not files:
        bot.reply_to(message, B("📂 𝐍𝐨 𝐟𝐢𝐥𝐞𝐬 𝐲𝐞𝐭.\n📤 𝐔𝐩𝐥𝐨𝐚𝐝 𝐚 .𝐩𝐲 𝐨𝐫 .𝐣𝐬 𝐟𝐢𝐥𝐞!"),
                     reply_markup=create_reply_keyboard_main_menu(user_id))
        return
...
def _callback_module_menu_direct(message, user_id):
    """𝐒𝐡𝐨𝐰 𝐦𝐨𝐝𝐮𝐥𝐞 𝐦𝐞𝐧𝐮 𝐝𝐢𝐫𝐞𝐜𝐭𝐥𝐲"""
    module_text = f"""╔══════════════════════════════════╗
║    📦 𝐌𝐎𝐃𝐔𝐋𝐄 𝐌𝐀𝐍𝐀𝐆𝐄𝐑             ║
╚══════════════════════════════════╝

*𝐈𝐧𝐬𝐭𝐚𝐥𝐥𝐞𝐝:* 𝐓𝐞𝐥𝐞𝐛𝐨𝐭, 𝐑𝐞𝐪𝐮𝐞𝐬𝐭𝐬, 𝐏𝐬𝐮𝐭𝐢𝐥, 𝐅𝐥𝐚𝐬𝐤
*𝐀𝐮𝐭𝐨-𝐢𝐧𝐬𝐭𝐚𝐥𝐥 𝐨𝐧 𝐮𝐩𝐥𝐨𝐚𝐝!*"""
    
    bot.reply_to(message, module_text, parse_mode='Markdown',
                 reply_markup=create_reply_keyboard_main_menu(user_id))

def _callback_restart_all_direct(message, user_id):
    """𝐑𝐞𝐬𝐭𝐚𝐫𝐭 𝐚𝐥𝐥 𝐟𝐫𝐨𝐦 𝐭𝐞𝐱𝐭 𝐛𝐮𝐭𝐭𝐨𝐧"""
    msg = bot.reply_to(message, B("🔄 𝐑𝐞𝐬𝐭𝐚𝐫𝐭𝐢𝐧𝐠 𝐚𝐥𝐥 𝐬𝐜𝐫𝐢𝐩𝐭𝐬..."))
...
# ================================
@bot.message_handler(func=lambda message: message.text and (
    B("➕ 𝐀𝐝𝐝 𝐀𝐝𝐦𝐢𝐧") in message.text or
    B("➖ 𝐑𝐞𝐦𝐨𝐯𝐞 𝐀𝐝𝐦𝐢𝐧") in message.text or
    B("📋 𝐋𝐢𝐬𝐭 𝐀𝐝𝐦𝐢𝐧𝐬") in message.text or
    B("📊 𝐒𝐲𝐬𝐭𝐞𝐦 𝐒𝐭𝐚𝐭𝐬") in message.text
))
def handle_admin_commands(message):
    """𝐇𝐚𝐧𝐝𝐥𝐞 𝐚𝐝𝐦𝐢𝐧 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐬"""
    user_id = message.from_user.id
    ...
    if B("➕ 𝐀𝐝𝐝 𝐀𝐝𝐦𝐢𝐧") in text:
        bot.reply_to(message, B("👤 𝐒𝐞𝐧𝐝 𝐮𝐬𝐞𝐫 𝐈𝐃 𝐭𝐨 𝐚𝐝𝐝 𝐚𝐬 𝐚𝐝𝐦𝐢𝐧:"))
    
    elif B("➖ 𝐑𝐞𝐦𝐨𝐯𝐞 𝐀𝐝𝐦𝐢𝐧") in text:
        bot.reply_to(message, B("👤 𝐒𝐞𝐧𝐝 𝐮𝐬𝐞𝐫 𝐈𝐃 𝐭𝐨 𝐫𝐞𝐦𝐨𝐯𝐞:"))
    
    elif B("📋 𝐋𝐢𝐬𝐭 𝐀𝐝𝐦𝐢𝐧𝐬") in text:
        admin_list = "\n".join([f"👑 {uid}" for uid in admin_ids])
        bot.reply_to(message, B(f"📋 𝐀𝐃𝐌𝐈𝐍𝐒:\n\n{admin_list}"),
                     reply_markup=create_reply_keyboard_main_menu(user_id))
    
    elif B("📊 𝐒𝐲𝐬𝐭𝐞𝐦 𝐒𝐭𝐚𝐭𝐬") in text:
...
💾 𝐑𝐀𝐌: {ram.percent}% ({ram.used // 1024 // 1024} 𝐌𝐁 𝐮𝐬𝐞𝐝)
⚙ 𝐂𝐏𝐔: {cpu}%
💽 𝐃𝐢𝐬𝐤: {disk.percent}% ({disk.used // (1024**3)} 𝐆𝐁 𝐮𝐬𝐞𝐝)
🚀 𝐑𝐮𝐧𝐧𝐢𝐧𝐠: {len(bot_scripts)}
👥 𝐔𝐬𝐞𝐫𝐬: {len(active_users)}"""
        
        bot.reply_to(message, stats, reply_markup=create_reply_keyboard_main_menu(user_id))

@bot.message_handler(func=lambda message: message.text and (
    B("➕ 𝐀𝐝𝐝 𝐒𝐮𝐛") in message.text or
    B("➖ 𝐑𝐞𝐦𝐨𝐯𝐞 𝐒𝐮𝐛") in message.text or
    B("🔍 𝐂𝐡𝐞𝐜𝐤 𝐒𝐮𝐛") in message.text
))
def handle_subscription_commands(message):
    """𝐇𝐚𝐧𝐝𝐥𝐞 𝐬𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐬"""
    user_id = message.from_user.id
    ...
    if B("➕ 𝐀𝐝𝐝 𝐒𝐮𝐛") in text:
        bot.reply_to(message, B("💳 𝐒𝐞𝐧𝐝: 𝐮𝐬𝐞𝐫_𝐈𝐃 𝐝𝐚𝐲𝐬 (𝐞.𝐠. 𝟏𝟐𝟑𝟒𝟓𝟔 𝟑𝟎)"))
    
    elif B("➖ 𝐑𝐞𝐦𝐨𝐯𝐞 𝐒𝐮𝐛") in text:
        bot.reply_to(message, B("💳 𝐒𝐞𝐧𝐝 𝐮𝐬𝐞𝐫 𝐈𝐃 𝐭𝐨 𝐫𝐞𝐦𝐨𝐯𝐞 𝐬𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧:"))
    
    elif B("🔍 𝐂𝐡𝐞𝐜𝐤 𝐒𝐮𝐛") in text:
        bot.reply_to(message, B("🔍 𝐒𝐞𝐧𝐝 𝐮𝐬𝐞𝐫 𝐈𝐃 𝐭𝐨 𝐜𝐡𝐞𝐜𝐤:"))
